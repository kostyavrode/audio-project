...
{
    Task<GroupDto> CreateGroupAsync(CreateGroupDto createGroupDto, string userId, CancellationToken cancellationToken = default);
    ...
    Task JoinGroupAsync(string groupId, JoinGroupDto joinGroupDto, string userId, CancellationToken cancellationToken = default);
